  ...
  return (
    <div className="pt-20 pb-40 font-Roboto" id="About ">
            ...
            >
              ...
              <div className="container p-2 mx-auto mt-10 mb-0">
                <div className="w-full md:w-full lg:w-full xl:flex">
                  <div className="p-10 m-3 duration-500 rounded-lg md:p-3 md:w-full lg:w-full xl:w-1/3 ">
                    ...
                    <div className="w-48 duration-300 rounded-lg bg-primary bg-opacity-70 hover:bg-custom-blue hover:text-green-400 hover:scale-105">
                      <a href="#Graphic">
                        <button
                  ...
                  <div className="p-10 m-3 duration-500 rounded-lg md:p-3 md:w-full lg:w-full xl:w-1/3 ">
                    ...
                    <div className="w-48 duration-300 rounded-lg bg-primary bg-opacity-60 hover:bg-custom-blue hover:text-green-400 hover:scale-105">
                      <a href="#Graphic">
                        <button
                  ...
                  <div className="p-10 m-3 duration-500 bg-opacity-50 rounded-lg md:p-3 md:w-full lg:w-full xl:w-1/3 ">
                    <h1 className="text-2xl font-semibold text-green-500 font-custom">
                      03
                    </h1>
                    <p className="mt-2 text-3xl font-bold text-center text-custom-blue md:text-xl">
      ...
      <div className="container py-8 mx-auto">
        ...
        <div className="grid grid-cols-1 gap-8 px-10 text-gray-300 lg:px-32 md:px-20 lg:grid-cols-2 xl:grid-cols-2">
          <div
          ...
          >
            ...
            <p className="p-8 text-sm text-justify duration-300 -translate-y-5 bg-opacity-50 rounded-lg hover:bg-opacity-100 hover:scale-110 md:text-md bg-primary">
