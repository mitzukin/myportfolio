...
import Resume from "./assets/Tajor_Resume.pdf";
...
function App() {
  ...
  const handleDownload = () => {
    ...
    link.href = Resume;
    link.download = 'Tajor_Resume.pdf'; // Specify the desired name for the downloaded file
    link.click();
  };
            ...
            >
              <div className="w-full p-4 md:w-1/2">
                <div className="flex flex-col mt-24 background-container md:mt-40">
                  ...
                  <button
                    ...
                    className="p-3 px-6 mx-auto mt-10 text-sm font-semibold text-gray-300 rounded-full w-36 bg-secondary font-Inter hover:bg-white hover:text-primary"
              ...
              <div className="w-full p-4 md:w-3/4">
                <div className="mt-56 mb-56 md:mt-60">
                  <h1
                    className="mb-5 text-5xl font-bold text-gray-300 md:text-5xl lg:text-7xl xl:text-8xl"
                    data-aos="fade-up"
                  ...
                  >
                    ...
                    on a mission to turn ideas into reality. Discover my passion
                    for design and innovation as we journey through a gallery of
                    creativity. Welcome to my digital portfolio, where every
                    pixel tells a story.
                  </p>
                </div>
              </div>
            ...
            <div className="pt-32 font-Roboto bg-Below">
              ...
              >
                ...
                <p className="px-5 text-justify text-gray-300 text-md md:mx-56 md:text-lg">
                  &emsp; &emsp; &emsp;I wanted to share my thoughts on my
                  journey as a student in web development to inspire others who
                  may be considering this path. I've been truly amazed by how
                  web development has opened up new opportunities for creativity
                  and innovation in my life.
                </p>
                <Testimonial />
              </div>
            </div>
